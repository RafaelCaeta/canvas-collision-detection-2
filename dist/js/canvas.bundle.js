...
var colors = ["#f9de59", "#e8a628", "#f98365", "#a1dffb"]; // Event Listeners
...
function Particle(x, y, radius, color) {
  ...
  this.update = function (particles) {
    ...
    for (var i = 0; i < particles.length; i++) {
      ...
      if (_this === particles[i]) continue; // Collision detection

      if (_utils__WEBPACK_IMPORTED_MODULE_0___default.a.distance(_this.x, _this.y, particles[i].x, particles[i].y) - _this.radius * 2 < 0) {
        _utils__WEBPACK_IMPORTED_MODULE_0___default.a.resolveCollision(_this, particles[i]);
      }
    ...
    if (Object(_utils__WEBPACK_IMPORTED_MODULE_0__["distance"])(mouse.x, mouse.y, _this.x, _this.y) < 150 && _this.opacity < 0.5) {
      _this.opacity += 0.02;
    } else if (_this.opacity > 0) {
      _this.opacity -= 0.02; // Contain opacity between 0 and 0.5
